...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "pk~SREAmBJK#TLtXYnxSBxrg6O2l2FpTa4jD_Q1TOyLJE_r9L2oYIdk",
...
BOT_NAME: process.env.BOT_NAME || "⏤͟͟͞͞𝄞∘̥⃟Keutly⏤͟͟ŠÙÑĞ JÏÑ-WØØ",
STICKER_NAME: process.env.STICKER_NAME || "⏤͟͟͞͞𝄞∘̥⃟Keutly⏤͟͟ŠÙÑĞ JÏÑ-WØØ",
CUSTOM_REACT: process.env.CUSTOM_REACT || "false",
CUSTOM_REACT_EMOJIS: process.env.CUSTOM_REACT_EMOJIS || "💝,💖,💗,❤️‍🩹,❤️,🧡,💛,💚,💙,💜,🤎,🖤,🤍",
DELETE_LINKS: process.env.DELETE_LINKS || "true",
OWNER_NUMBER: process.env.OWNER_NUMBER || "2250788145722",
OWNER_NAME: process.env.OWNER_NAME || "⏤͟͟͞͞𝄞∘̥⃟Keutly⏤͟͟ŠÙÑĞ JÏÑ-WØØ",
